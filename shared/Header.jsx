...
const menu = [
  ...
  { title: '朋友', href: 'https://blog.85x6978.back-service.hajeekn.eu.org/link', delay: 'delay-[400ms]' },
];
    ...
    <header className="py-4">
      <div className="max-w-2xl mx-auto px-4 flex items-center justify-between relative">
        <Link className="flex items-center" href="/">
          <Image className="rounded-full" src="/avatar.webp" alt="Avatar" width={38} height={38} />
          <p className="ml-2 font-bold text-xl text-gray-800">Hajeekn</p>
        </Link>
